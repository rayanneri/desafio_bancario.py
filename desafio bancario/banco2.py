...
def exibir_extrato(saldo, /, *, extrato):
    ...
    if not extrato:
        ...
        for data, transacao in sorted(extrato, key=lambda x: x[0]):
...
def criar_usuario(usuarios):
    ...
    if not validar_cpf(cpf):
        print("\n*** CPF inválido! Por favor, informe um CPF válido com 11 dígitos numéricos. ***")
        return
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    if usuario:
        ...
        return {"agencia": agencia, "numero_conta": str(numero_conta), "usuario": usuario, "saldo": 0, "extrato": []}
